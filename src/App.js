...
const TRANSLATIONS = {
  en: { appTitle: 'PARVAZ HIDAYA', navHome: 'Home', navHistory: 'History', navFavorites: 'Favorites', subtitle: 'GENTLE ISLAMIC REMINDERS FOR WANDERING SOULS', placeholder: 'Enter an emotion or moment...', button: 'RECEIVE GUIDANCE', emptyState: 'Share what weighs on your heart, and recieve guidance of gentle wisdom and hope', loading: 'Crafting a reminder for you...', footer: 'Let your soul take flight', historyTitle: 'YOUR JOURNEY', historySubtitle: 'GUIDANCE AND WISDOM FROM YOUR HEART', favoritesTitle: 'YOUR JOURNEY', favoritesSubtitle: 'GUIDANCE AND WISDOM FROM YOUR HEART', suggestions: ['lonely', 'hope', 'fear', 'patience', 'gratitude', 'lost', 'new beginning', 'strength'], shareText: 'Gentle Islamic reminders for wandering souls', madeBy: 'Made by Maliha Parvaz' },
  ar: { appTitle: 'بَرْوَاز هِدَايَة', navHome: 'الرئيسية', navHistory: 'السجل', navFavorites: 'المفضلة', subtitle: 'تذكيرات إسلامية لطيفة للنفوس التائهة', placeholder: 'أدخل مشاعرك أو لحظتك...', button: 'استقبل الهداية', emptyState: 'شارك ما يثقل قلبك، واستقبل هدى من الحكمة اللطيفة والأمل.', loading: 'نُحضّر تذكيراً لك...', footer: 'دع روحك تحلق', historyTitle: 'رحلتك', historySubtitle: 'الهداية والحكمة من قلبك', favoritesTitle: 'رحلتك', favoritesSubtitle: 'الهداية والحكمة من قلبك', suggestions: ['وحيد', 'أمل', 'خوف', 'صبر', 'شكر', 'ضائع', 'بداية جديدة', 'قوة'], shareText: 'تذكيرات إسلامية لطيفة للنفوس التائهة', madeBy: 'صنعت بواسطة مالحة بارواز' },
  ur: { appTitle: 'پرواز ہدایت', navHome: 'ہوم', navHistory: 'ریکارڈ', navFavorites: 'پسندیدہ', subtitle: 'بھٹکتی روحوں کے لیے نرم اسلامی یاد دہانیاں', placeholder: 'اپنا احساس یا لمحہ درج کریں...', button: 'ہدایت حاصل کریں', emptyState: 'اپنے دل کا بوجھ بانٹیں، اور نرم حکمت اور امید کی رہنمائی حاصل کریں۔', loading: 'آپ کے لیے ایک یاد دہانی تیار کی جا رہی ہے...', footer: 'اپنی روح کو پرواز دیں', historyTitle: 'آپ کا سفر', historySubtitle: 'آپ کے دل سے رہنمائی اور حکمت', favoritesTitle: 'آپ کا سفر', favoritesSubtitle: 'آپ کے دل سے رہنمائی اور حکمت', suggestions: ['تنہا', 'امید', 'خوف', 'صبر', 'شکر', 'کھویا', 'نیا آغاز', 'طاقت'], shareText: 'بھٹکتی روحوں کے لیے نرم اسلامی یاد دہانیاں', madeBy: 'مالحہ پارواز کے ذریعے بنایا گیا' },
  hi: { appTitle: 'पारवाज़ हिदाया', navHome: 'होम', navHistory: 'इतिहास', navFavorites: 'पसंदीदा', subtitle: 'भटकी हुई रूहों के लिए कोमल इस्लामी अनुस्मरण', placeholder: 'अपनी भावना या पल दर्ज करें...', button: 'मार्गदर्शन प्राप्त करें', emptyState: 'अपने दिल का बोझ साझा करें और कोमल ज्ञान और आशा की मार्गदर्शना प्राप्त करें।', loading: 'आपके लिए एक अनुस्मारक तैयार किया जा रहा है...', footer: 'अपनी रूह को उड़ान दें', historyTitle: 'आपकी यात्रा', historySubtitle: 'आपके दिल से मार्गदर्शन और ज्ञान', favoritesTitle: 'आपकी यात्रा', favoritesSubtitle: 'आपके दिल से मार्गदर्शन और ज्ञान', suggestions: ['अकेलापन', 'उम्मीद', 'डर', 'सब्र', 'शुक्र', 'खोया', 'नई शुरुआत', 'ताकत'], shareText: 'भटकी हुई रूहों के लिए कोमल इस्लामी अनुस्मरण', madeBy: 'मालिहा परवाज़ द्वारा बनाया गया' },
  tr: { appTitle: 'PARVAZ HIDAYA', navHome: 'Ana', navHistory: 'Geçmiş', navFavorites: 'Favoriler', subtitle: 'Kaybolmuş ruhlar için nazik İslami hatırlatmalar', placeholder: 'Bir duygu veya an girin...', button: 'Hidayet Al', emptyState: 'Kalbindeki yükü paylaş ve nazik hikmet ve umudun rehberliğini al.', loading: 'Senin için bir hatırlatıcı hazırlanıyor...', footer: 'Ruhunu uçur', historyTitle: 'SENİN YOLCULUĞUN', historySubtitle: 'KALBİNDEN REHBERLİK VE BİLGELİK', favoritesTitle: 'SENİN YOLCULUĞUN', favoritesSubtitle: 'KALBİNDEN REHBERLİK VE BİLGELİK', suggestions: ['yalnız', 'umut', 'korku', 'sabır', 'şükür', 'kayıp', 'yeni başlangıç', 'güç'], shareText: 'Kaybolmuş ruhlar için nazik İslami hatırlatmalar', madeBy: 'Maliha Parvaz tarafından yapıldı' },
  id: { appTitle: 'PARVAZ HIDAYA', navHome: 'Beranda', navHistory: 'Riwayat', navFavorites: 'Favorit', subtitle: 'Pengingat Islami lembut untuk jiwa yang tersesat', placeholder: 'Masukkan perasaan atau momen...', button: 'Dapatkan Bimbingan', emptyState: 'Bagikan beban hatimu, dan terima bimbingan dari hikmah lembut dan harapan.', loading: 'Menyusun pengingat untukmu...', footer: 'Biarkan jiwamu terbang', historyTitle: 'PERJALANANMU', historySubtitle: 'BIMBINGAN DAN KEBIJAKSANAAN DARI HATIMU', favoritesTitle: 'PERJALANANMU', favoritesSubtitle: 'BIMBINGAN DAN KEBIJAKSANAAN DARI HATIMU', suggestions: ['kesepian', 'harapan', 'takut', 'sabar', 'syukur', 'hilang', 'awal baru', 'kekuatan'], shareText: 'Pengingat Islami lembut untuk jiwa yang tersesat', madeBy: 'Dibuat oleh Maliha Parvaz' },
  fr: { appTitle: 'PARVAZ HIDAYA', navHome: 'Accueil', navHistory: 'Historique', navFavorites: 'Favoris', subtitle: 'Rappels islamiques doux pour les âmes perdues', placeholder: 'Entrez une émotion ou un moment...', button: 'Recevoir la guidance', emptyState: 'Partage ce qui pèse sur ton cœur et reçois une guidance de sagesse douce et d’espoir.', loading: 'Création d’un rappel pour toi...', footer: "Laisse ton âme s'élever", historyTitle: 'TON VOYAGE', historySubtitle: 'GUIDANCE ET SAGESSE DE TON CŒUR', favoritesTitle: 'TON VOYAGE', favoritesSubtitle: 'GUIDANCE ET SAGESSE DE TON CŒUR', suggestions: ['solitude', 'espoir', 'peur', 'patience', 'gratitude', 'perdu', 'nouveau départ', 'force'], shareText: 'Rappels islamiques doux pour les âmes perdues', madeBy: 'Créé par Maliha Parvaz' },
  es: { appTitle: 'PARVAZ HIDAYA', navHome: 'Inicio', navHistory: 'Historial', navFavorites: 'Favoritos', subtitle: 'Recordatorios islámicos suaves para almas perdidas', placeholder: 'Ingresa una emoción o momento...', button: 'Recibir guía', emptyState: 'Comparte lo que pesa en tu corazón y recibe guía de sabiduría gentil y esperanza.', loading: 'Creando un recordatorio para ti...', footer: 'Deja que tu alma vuele', historyTitle: 'TU VIAJE', historySubtitle: 'GUÍA Y SABIDURÍA DE TU CORAZÓN', favoritesTitle: 'TU VIAJE', favoritesSubtitle: 'GUÍA Y SABIDURÍA DE TU CORAZÓN', suggestions: ['soledad', 'esperanza', 'miedo', 'paciencia', 'gratitud', 'perdido', 'nuevo comienzo', 'fuerza'], shareText: 'Recordatorios islámicos suaves para almas perdidas', madeBy: 'Creado por Maliha Parvaz' },
  zh: { appTitle: '巴尔瓦兹·希达亚', navHome: '首页', navHistory: '历史', navFavorites: '收藏', subtitle: '为迷失的心灵准备的温柔伊斯兰提醒', placeholder: '输入一种情感或时刻...', button: '接收指引', emptyState: '分享你心中的重担，并获得温柔智慧与希望的指引。', loading: '为你制作一则提醒...', footer: '让你的心灵飞翔', historyTitle: '你的旅程', historySubtitle: '来自你心的指引与智慧', favoritesTitle: '你的旅程', favoritesSubtitle: '来自你心的指引与智慧', suggestions: ['孤独', '希望', '恐惧', '耐心', '感恩', '迷失', '新开始', '力量'], shareText: '为迷失的心灵准备的温柔伊斯兰提醒', madeBy: '由马莱哈·帕瓦兹创建' }
};
