...
const TRANSLATIONS = {
  ...
  ar: { appTitle: 'بَرْوَاز هِدَايَة', navHome: 'الرئيسية', navHistory: 'السجل', navFavorites: 'المفضلة', subtitle: 'قصص إسلامية لطيفة للنفوس التائهة', placeholder: 'أدخل مشاعرك أو لحظتك...', button: 'استقبل الهداية', emptyState: 'شارك ما يثقل قلبك، واستقبل قصة من الحكمة اللطيفة والأمل.', loading: 'نصنع قصتك...', footer: 'دع روحك تحلق', historyTitle: 'رحلتك', historySubtitle: 'القصص والحكمة من قلبك', favoritesTitle: 'رحلتك', favoritesSubtitle: 'القصص والحكمة من قلبك', suggestions: ['وحيد', 'أمل', 'خوف', 'صبر', 'شكر', 'ضائع', 'بداية جديدة', 'قوة'], shareText: 'قصص إسلامية لطيفة للنفوس التائهة', madeBy: 'صنعت بواسطة مالحة بارواز' },
